...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # The absolute filesystem path to the directory that will hold media files
...
ALLOWED_HOSTS = ['localhost','192.168.0.100','192.168.0.100:81','127.0.0.1:8000','127.0.0.1']
